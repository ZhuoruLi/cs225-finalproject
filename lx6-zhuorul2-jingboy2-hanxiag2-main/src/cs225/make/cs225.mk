...
# Flags for compile:
CXXFLAGS += $(CS225) -std=c++1y -stdlib=libc++ -O0 $(WARNINGS) $(DEPFILE_FLAGS) -g -c -D_GLIBCXX_DEBUG
...
$(RELEASE): output_msg $(patsubst %.o, $(OBJS_DIR)/%.o, $(OBJS))
...
# Final Project specific
	@mkdir -p $(OBJS_DIR)/bfs
	@mkdir -p $(OBJS_DIR)/csv_parser
	@mkdir -p $(OBJS_DIR)/stickers
